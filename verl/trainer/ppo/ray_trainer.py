...
class RayPPOTrainer:
    ...
    def _get_gen_batch(self, batch: DataProto) -> DataProto:
        reward_model_keys = set({"data_source", "reward_model", "original_image", "extra_info", "uid"}) & batch.non_tensor_batch.keys()
    ...
    def fit(self):
        ...
        for epoch in range(current_epoch, self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                # add original image if not have
                if "original_image" not in batch.non_tensor_batch.keys():
                    batch.non_tensor_batch["original_image"] = batch.non_tensor_batch["multi_modal_data"]
